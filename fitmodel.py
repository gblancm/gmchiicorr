...
with Pool() as pool:
    sampler = emcee.EnsembleSampler(nwalkers, ndim, log_prob, pool=pool, moves=[(emcee.moves.StretchMove(a=1.5), 1.0), (emcee.moves.DEMove(), 0.0),(emcee.moves.DESnookerMove(), 0.0),])
