...
def log_prob(p):
    ...
    if np.isfinite(lprior):
        r0, w0, ew0, fhg0 = eval_w(l0=p[0], rc0=p[1], tc0=p[2], ts0=p[3], tfb0=p[4], Ng0=p[5], voff0=p[6], bins=r0obs)
        res=w0-w0obs[selr]
        sig=ew0obs[selr]
...
ax.plot([0], [0], label="l="+"{:.2f}".format(pbest[0]))
ax.plot([0], [0], label="rc="+"{:.2f}".format(pbest[1]))
ax.plot([0], [0], label="tc="+"{:.2f}".format(pbest[2]))
ax.plot([0], [0], label="ts="+"{:.2f}".format(pbest[3]))
ax.plot([0], [0], label="tfb="+"{:.2f}".format(pbest[4]))
ax.plot([0], [0], label="Ng="+"{:.2f}".format(pbest[5]))
ax.plot([0], [0], label="voff="+"{:.2f}".format(pbest[6]))
